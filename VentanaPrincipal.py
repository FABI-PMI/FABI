...
class ElementButton:
    ...
    def __init__(self, x, y, element_type, palette, game):
        ...
        self.config = {
            'sand': {'color': '#DEB887', 'icon': '⛰️', 'name': 'Arena', 'price': 50, 'class': RookArena},
            'rock': {'color': '#696969', 'icon': '🪨', 'name': 'Roca', 'price': 100, 'class': RookRoca},
            'water': {'color': '#4682B4', 'icon': '💧', 'name': 'Agua', 'price': 150, 'class': RookAgua},
